...
This is an addon for [Statamic Peak](https://github.com/studio1902/statamic-peak) that contains tools like the CSRF token logic, picture partial, the noscript partial, the toolbar and the missing alt text widget.
